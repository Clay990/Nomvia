...
interface PostOptionsModalProps {
    ...
    isOwner?: boolean;
    onClose: () => void;
    onSelect: (option: 'share' | 'report' | 'block' | 'delete') => void;
}

const { height } = Dimensions.get('window');

export default function PostOptionsModal({ visible, isOwner, onClose, onSelect }: PostOptionsModalProps) {
    ...
    const handleOption = (option: 'share' | 'report' | 'block' | 'delete') => {

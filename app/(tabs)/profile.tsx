      ...
      >
        <View style={styles.profileInfoContainer}>
             ...
             <View style={styles.statsRow}>
                 ...
                 <View style={styles.stat}><Text style={styles.statNum}>48</Text><Text style={styles.statLabel}>Countries</Text></View>
                 <View style={styles.divider} />
                 <View style={styles.stat}><Text style={styles.statNum}>Top 1%</Text><Text style={styles.statLabel}>Builder</Text></View>
             </View>
             ...
             <View style={styles.actionRow}>
                 ...
                 <TouchableOpacity style={styles.iconActionBtn} onPress={() => router.push('/messages')}>
